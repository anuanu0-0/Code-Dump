...
public class Question1 {
    public static void main(String[] args) {
        ...
        List<Employee> employees = Arrays.asList(new Employee (1, "Shivam", "Singh", "shivitsdai77@gmail.com", tech, 9.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (2, "Tanya", "Verma", "asdasdasl772gmail.com", hr, 99.6 ,LocalDate.of(2000, 12, 3),
                                                    new Employee (3, "jackson", "Rawat", "asdasd@gmail.com", ops, 95450.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (4, "anupam", "Rawat", "asdafaf@gmail.com", hr,968550.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (5, "pranjal", "Rawat", "tnaknsd@gmail.com", account, 95816810.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (6, "Anshu", "Rawat", "rasdasdul772gmail.com", hr, 91215150.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (7, "test0 ", "Rawat", "adasd772gmail.com", ops, 951510.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (8, "test1", "Rawat", "rahul772gmail.com", account, 91518180.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (9, "test2", "Rawat", "rahul7ad72gmail.com", tech, 992510.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (10, "test3", "Rawat", "rahul77das2gmail.com", ops, 9151810.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (11, "test4", "Rawat", "rahul77asd2gmail.com", account,952190.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (12, "test5", "Rawat", "rahuldas772gmail.com", tech, 662690.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (13, "test6", "Rawat", "rahul77da2dgmail.com", tech, 1589290.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (14, "test7", "Rawat", "rahul77das2gmail.com", account, 8181290.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (15, "test8", "Rawat", "rahul7das72gmail.com", hr,2189190.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (16, "test9", "Rawat", "rahul77asd2gmail.com", ops, 881890.0, LocalDate.of(2000, 12, 3),
                                                    new Employee (17, "test10", "test10", "rahulads772gmail.com", 6251590.0, LocalDate.of(2000, 12, 3));
        /**
